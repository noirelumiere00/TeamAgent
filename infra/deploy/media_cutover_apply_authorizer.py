...
def authorize_media_apply(
    ...
    *,
    ...
    if confirmed_lock is None or confirmed_intent is None or confirmed_media is None:
    ...
    if confirmed_media != expected_media:
        raise AuthorizationError("media evidence was not consumed exactly once")
    authorization = {
        "kind": "teamagent-media-apply-authorization",
        "schema_version": 1,
        "state": "AUTHORIZED",
        "record_id": media_record_id,
        "image_deployment_intent_id": metadata["intent_id"],
        "apply_attempt_id": attempt_id,
        "plan_sha256": metadata["plan_sha256"],
        "claims_sha256": verification["claims_sha256"],
        "signature_sha256": verification["signature_sha256"],
        "kms_key_arn": verification["kms_key_arn"],
        "migration_contract_sha256": migration_contract_sha256,
        "reviewed_plan_sha256": reviewed_plan_sha256,
        "authorized_at_epoch": observed_at,
        "lock_lease_expires_at": confirmed_lock["lease_expires_at"],
