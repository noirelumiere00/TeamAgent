...
resource "aws_codebuild_project" "image" {
  ...
  source {
    ...
    buildspec = "${aws_s3_bucket.image_release_evidence.arn}/codebuild-buildspecs/${local.main_codebuild_project_name}/5a9a977b306926fbd7801366d6937f92e8eb7a188e23c9cd3c1e2ff6bd48a70a.yml"
  }
