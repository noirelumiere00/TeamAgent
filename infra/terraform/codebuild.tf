...
resource "aws_codebuild_project" "image" {
  ...
  source {
    ...
    buildspec = "${aws_s3_bucket.image_release_evidence.arn}/codebuild-buildspecs/${local.main_codebuild_project_name}/ea7a6c318bdd51147bc17315161c19d7b7d5d404a1adad0ef97f489e0dbb0dd3.yml"
  }
