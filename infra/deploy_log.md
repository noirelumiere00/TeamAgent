...
- 生成実測: Vault `clients=820 / planned=written=1829 / delete_planned=0`。公開HTMLは `clients=599 / docs=856 / graph=1548n 4466e / 実リンク=1895 / FB timeline=568 / size=4,730KB`（前回 2026-07-17 は clients=516 / docs=662）。縮小ガードは非該当（増加）。 証跡は `manifest_sha256=1f4829847329226250f7e8414d8ff28e4731deaa948b8988f5164f011ac1871d` / `build_inputs_sha256=c73aaeef3d1f49d839982c78d72d6e4d985489ebc2a86104b5690b295d9df6fa` / `app_html_sha256=16cf0fedabf6c7f940724730cb21d394d9e2d15201bfd92335241feda432b831` / `app_html_s3_version_id=TFuClUMRy.qrlxsNdtZpHBazdrCQEsLE`。
