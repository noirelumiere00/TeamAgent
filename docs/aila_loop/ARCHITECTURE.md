...
| 8 | **Vertex AI (Gemini 2.5 Flash)** | 動画マルチモーダル分析。請求は GCP `newstv-508906`（会社・2026-09-17 に `ntv-ai` から移行） | — | GCP マネージド | teamagent-mcp (video tools) | — | Vertex SA JSON (Secrets Manager → `load_secrets.sh`) |
